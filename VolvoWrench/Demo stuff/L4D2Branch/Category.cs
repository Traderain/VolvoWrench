...
namespace VolvoWrench.Demo_Stuff.L4D2Branch
{
    ...
    {
        /// <summary>
        ///     The details of CSGO (this is handled by the csgo parser but incase something brakes)
        /// </summary>
        public static readonly Category Csgo = new Category("CSGO", 66.6, new string[1], new string[1]);

        /// <summary>
        ///     Anything unidentifiably
        /// </summary>
        ...
        /// <summary>
        ///     The details of Portal 2 Singleplayer
        /// </summary>
        public static readonly Category Portal2Sp = new Category("Portal 2", 60,
            new[]
            {
                ...
                "sp_a2_triple_laser", "sp_a2_bts1", "sp_a2_bts2", "sp_a2_bts3", "sp_a2_bts4", "sp_a2_bts5", "sp_a2_bts6",
        ...
        public static readonly Category Portal2Coop = new Category("Portal 2 Coop", 60,
            new[]
            {
                ...
                "mp_coop_multifling_1", "mp_coop_fling_crushers", "mp_coop_fan", "mp_coop_lobby_3", "mp_coop_wall_intro",
            ...
            new[]
            {
                "Calibration", "Lobby 1", "Doors", "Buttons", "Lasers", "Rat Maze", "Laser Crushers", "Behind the Scenes",
        ...
        private Category(string name, double tps, string[] maps, string[] mapNames)
        {
            Name = name;
            TicksPerSecond = tps;
            Maps = maps;
